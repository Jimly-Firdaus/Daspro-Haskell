module ListOfInteger where
    ...
    elmtKeN :: [Int]-> Int -> Int 
    {-
    elmtKeN yang menerima masukan sebuah list of integer, misalnya l, dan sebuah integer, 
    misalnya n, dan menghasilkan elemen ke-n dari list of integer l. 
    Diasumsikan 0 < n <= banyaknya elemen l dan list l tidak kosong 
    (minimum terdiri atas 1 elemen).
    -}
    elmtKeN l n =
        if isOneElmt l then head l
        else if n==1 then head l
